...
<div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
  <div className="px-4 pt-8">
    ...
    <form className="mt-5 grid gap-6">
      <div className="relative">
        ...
        <label className="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" htmlFor
        ="radio_1">
  ...
  <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
    ...
    <div className="">
      <label htmlFor
      ="email" className="mt-4 mb-2 block text-sm font-medium">Email</label>
      <div className="relative">
      ...
      <label htmlFor
      ="card-holder" className="mt-4 mb-2 block text-sm font-medium">Card Holder</label>
      <div className="relative">
      ...
      <label htmlFor
      ="card-no" className="mt-4 mb-2 block text-sm font-medium">Card Details</label>
      <div className="flex">
      ...
      <label htmlFor
      ="billing-address" className="mt-4 mb-2 block text-sm font-medium">Billing Address</label>
